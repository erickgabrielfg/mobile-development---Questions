package com.example.apppost.viewmodel
...
class PostViewModel: ViewModel() {
    ...
    fun deletePost(postInt: Int){
        viewModelScope.launch {
            try {
                RetrofitInstance.api.deletePost(postInt)
                fetchPosts()
            }
            catch (e: Exception){
                e.printStackTrace()
    ...
    fun updatePost(
        ...
        viewModelScope.launch {
            try {
                ...
                RetrofitInstance.api.updatePost(postInt, updatePost)
                fetchPosts()
            }
            catch (e: Exception){
                e.printStackTrace()
